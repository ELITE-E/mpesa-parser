...
def analyzed_transactions():
    ...
    return pd.DataFrame(
        [
            {
                "receipt_no": "1",
                "completion_time": "2026-07-01 10:00:00",
                "details": "KPLC 888888",
                "category": "PURCHASE",
                "withdrawn": 1000.0,
                "total_cost": 1000.0,
            ...
            {
                "receipt_no": "2",
                "completion_time": "2026-07-05 12:00:00",
            ...
            {
                "receipt_no": "3",
                "completion_time": "2026-07-10 14:00:00",
            ...
            {
                "receipt_no": "4",
                "completion_time": "2026-08-01 09:00:00",
                "details": "KPLC 888888",
                "category": "PURCHASE",
                "withdrawn": 2000.0,
                "total_cost": 2000.0,
...
def test_analytics_handles_empty_dataframe():
    """Defensive boundary check confirming
    empty inputs return clean empty structures."""
...
def test_analytics_handles_malformed_and_missing_dates(analyzed_transactions):
    """Ensures corrupt or missing completion times are
    safely bucketed as 'Unknown' instead of crashing."""
    ...
    # The broken rows (1000.0 + 29.0) should accumulate
    # safely into an 'Unknown' categorization bucket
